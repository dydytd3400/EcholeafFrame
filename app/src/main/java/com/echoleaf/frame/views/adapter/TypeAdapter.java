...
public abstract class TypeAdapter extends BaseAdapter {
	 ...
	 * @return text view
	 */
	protected TextView setText(final View parentView, final int childViewIndex, final CharSequence text ) {
	 ...
	 * @return text view
	 */
	protected TextView setText(final View parentView, final int childViewIndex, final int resourceId ) {
	 ...
	 * @return child view
	 */
	protected <T> T getView(final View parentView, final int childViewIndex, final Class<T> childViewClass ) {
	 ...
	 * @return check box
	 */
	protected CompoundButton setChecked(final View parentView, final int childViewIndex, final boolean checked ) {
	 ...
	 * @return text view
	 */
	public TextView setVisibleText(final View parentView, final int childViewIndex, final CharSequence text ) {
	 ...
	 * @return text view
	 */
	public TextView setRelativeTimeSpan(final View parentView, final int childViewIndex, final long time ) {
