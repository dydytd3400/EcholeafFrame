...
public abstract class SingleTypeCursorAdapter extends CursorAdapter {
	 ...
	 */
	public SingleTypeCursorAdapter(final Activity activity, final Cursor cursor, final int flags, final int layoutResourceId ) {
		this ( activity, cursor, flags, activity.getLayoutInflater (), layoutResourceId );
	}
	 ...
	 * @param layoutResourceId
	 */
	public SingleTypeCursorAdapter(final Context context, final Cursor cursor, final int flags, final int layoutResourceId ) {
	 ...
	 * @param layoutResourceId
	 */
	public SingleTypeCursorAdapter(final Context context, final Cursor cursor, final int flags, final LayoutInflater inflater, final int layoutResourceId ) {
	 ...
	 * @return text view
	 */
	protected TextView setRelativeTimeSpan(final int childViewIndex, final int columnIndex ) {
