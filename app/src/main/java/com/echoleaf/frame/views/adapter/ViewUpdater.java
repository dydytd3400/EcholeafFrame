...
public class ViewUpdater {
	 ...
	 * @return text view
	 */
	public TextView setText(final View parentView, final int childViewIndex, final CharSequence text ) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public <T> T getView(final View parentView, final int childViewIndex, final Class<T> childViewClass ) {
