...
/**
 * 滑动关闭当前Activity的Controller
 */
public class SwipeBackController implements TouchEventController {
    ...
    public static final int DEFAULT_TOUCH_THRESHOLD = 80;//默认开始滑动的位置距离左边缘的距离
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (!isMoving) {
                    ...
                    //mScreenWidth 为整个屏幕宽度可识别区域 DEFAULT_TOUCH_THRESHOLD
